// FGTelnetConnection.java - client library for the FlightGear flight simulator.
 ...
 *
 * <blockquote><pre>
 * FGTelnetConnection fgfs = new FGTelnetConnection("localhost", 9000);
 * </pre></blockquote>
 *
 ...
 * connection.</p>
 */
public class FGTelnetConnection
{
...

     ...
     */
    public FGTelnetConnection (String host, int port)
	throws IOException
    {
